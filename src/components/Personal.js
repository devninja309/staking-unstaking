                ...
                <div className="field mt-5">
                  <div className="first-tables">
                    ...
                    <div className="f-table">
                      <input type="text" className="first-input" placeholder="John"></input>
                      <input type="text" className="first-input" placeholder="Doe"></input>
                    </div>
                  </div>
                </div>
                <div className="field mt-5">
                  <div className="other-tables">
                    ...
                    <input type="email" className="other-input" placeholder="name@email.com"></input>
                  </div>
                </div>
                <div className="field mt-5">
                  <div className="other-tables">
  ...
  <input type="tel" className="other-input" placeholder="+1 234 567 890" ></input>
                ...
                <div className="field mt-5">
                  <button className="button is-link is-large is-fullwidth">
                    <Link className="get-link" to="/insurance" >SEND</Link>
                  </button>
                </div>
              </form>
            </div>
